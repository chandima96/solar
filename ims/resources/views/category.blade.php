            ...
            <div class="px-4 sm:px-6 lg:px-8">
              <div class="sm:flex sm:items-center">
                <div class="sm:flex-auto">
                  ...
                  <p class="mt-2 text-sm text-gray-700">A list of all the category in your account including their Id, Batch Description Name, Batch Prefix.</p>
                </div>
                ...
                <table class="min-w-full divide-y divide-gray-300">
                  <thead>
                    <tr>
                      ...
                      <th scope="col" class="relative group px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Batch Prefix
                        <div class="opacity-0 invisible group-hover:opacity-100 group-hover:visible absolute bg-gray-100 border-2 text-gray-800 text-xs font-normal py-2 px-4 rounded-md mt-2 transition duration-300">
                          Description goes here.
                        </div>
                      </th>                    
                  ...
                  @foreach ($categories as $category)
                    <tr class="hover:bg-slate-100 hover:duration-300">
                      <td class="whitespace-nowrap px-3 py-4 text-sm font-medium text-gray-900">{{ $category->id }}</td>
