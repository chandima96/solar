...
@section('content')
    ...
    <div>
            <div class="px-4 sm:px-6 lg:px-8">
              <div class="sm:flex sm:items-center">
                <div class="sm:flex-auto">
                  ...
                  <p class="mt-2 text-sm text-gray-700">A list of all the products in your account including their id, name, description, type.</p>
                </div>
                ...
                <table class="min-w-full divide-y divide-gray-300">
                  <thead>
                    <tr>
                      ...
                      <th scope="col" class="relative group px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Description
                        <div class="opacity-0 invisible group-hover:opacity-100 group-hover:visible absolute bg-gray-100 border-2 text-gray-800 text-xs font-normal py-2 px-4 rounded-md mt-2 transition duration-300">
                          Description goes here.
                        </div>
                      </th>
                      <th scope="col" class="relative group px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Type
                        <div class="opacity-0 invisible group-hover:opacity-100 group-hover:visible absolute bg-gray-100 border-2 text-gray-800 text-xs font-normal py-2 px-4 rounded-md mt-2 transition duration-300">
                          Description goes here.
                        </div>
                      </th>
                  ...
                  <tbody class="divide-y divide-gray-200 bg-white">
                    ...
                    <tr class="hover:bg-slate-100 hover:duration-300">
                      <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-0">{{$product->id}}</td>
            ...
            <!-- model Update -->
                          <button class="text-green-600 hover:text-green-700 mx-2" onclick="openEditModal('{{ route('products.edit', ['product' => $products]) }}')">Edit</span></button>
                          ...
                          <button class="text-red-400 hover:text-red-600 mr-1"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
                           ...
                           <a href="./Final.html" class="text-indigo-500 relative group hover:text-indigo-500">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-three-dots-vertical mx-1" viewBox="0 0 16 16">
                              <path d="M9.5 13a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0m0-5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0m0-5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0"/>
                            </svg>
                            <div class="opacity-0 invisible group-hover:opacity-100 group-hover:visible absolute bg-indigo-300 text-black text-sm py-1 px-4 rounded-md mt-2 transition duration-300 left-[-600%]">
