...
@section('content')
    ...
    <div class="px-14 ml-10 mx-auto">
        <h1 class="font-inter font-semibold text-2xl mt-9">Quotation Item Name</h1>
        <div class="pt-10 grid gap-y-3 font-normal font-inter text-base">
            <h2 >Description </h2>
            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the 
                industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type 
                and scrambled it to make a type specimen book. It has survived not only five centuries, but also</p>
        </div>
