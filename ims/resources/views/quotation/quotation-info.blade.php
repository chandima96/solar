...
@section('content')
    ...
    <div>
        <div class="px-14 ml-10 mx-auto">
            <h1 class="font-inter font-semibold text-2xl mt-9">Quotation Information</h1>
                    ...
                    <div class="overflow-x-auto py-10">
                        <table class="table-auto w-full">
                            ...
                            <tbody class="text-gray-900 font-normal text-sm border-b border-gray-200">
                                ...
                                <td>
                                    <div class="bg-[#333333] flex justify-center items-center border rounded-lg w-36 h-8 pt-4 pr-2 pb-4 pl-2">
