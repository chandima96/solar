...
@section('content')
    ...
    <div class="px-14 ml-10 mx-auto">
        <h1 class="font-inter font-semibold text-2xl mt-9">Quotations</h1>
        ...
        <div class="flex flex-col md:flex-row mt-12 md:gap-x-4">
            ...
            <div class="bg-[#333333] flex justify-center items-center border rounded-lg">
            ...
            <div type="button" onclick="openAddModal()" class="bg-[#333333] flex justify-center items-center border rounded-lg">
                <button class="text-white font-inter text-sm font-medium flex justify-center items-center px-3 py-1.5 gap-x-2">
                    <svg class="h-3 w-3" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <div id="addModal" class="fixed inset-0 z-10 overflow-y-auto hidden">
                <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                    ...
                    <div class="inline-block bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all 
                        ...
                        <div class="bg-white ">
                            <p class="mb-7 font-medium text-lg font-inter">Add New Quotation</p>
                ...
                <tbody class="text-gray-900 font-normal text-sm border-b border-gray-200">
                    ...
                    <td>
                        <div class="flex justify-center gap-x-2">
                            ...
                            <button type="button" onclick="openDeleteModal()" class="text-red-400 hover:text-red-600 ">
                        ...
                        <div class="flex justify-center gap-x-2">
                            ...
                            <div id="deleteModal" class="fixed inset-0 z-10 overflow-y-auto hidden">
                                <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                                    ...
                                    <span class="hidden sm:inline-block sm:align-middle sm:h-screen" aria-hidden="true">&#8203;</span>
                                    <div class="inline-block bg-gray-50 rounded-lg text-left overflow-hidden shadow-xl transform transition-all 
                                                                    sm:align-middle w-[548px] h-[213px] top-[131px] left-[514px] p-7 gap-8">
                                        <div class="bg-white p-6 border border-transparent rounded-lg">
                                            <div class="grid grid-cols-1 gap-3">
                                                <label class="flex items-center">
                                                    <input type="checkbox" class="form-checkbox h-4 w-4 text-indigo-600">
                                                    <h2 class="font-medium text-lg font-inter ml-4">Are you sure do you want to delete?</h2>
                                                </label>
                                            </div>
                                            <div class="flex justify-end items-end gap-x-4 mt-8">
                                            <div onclick="openDeleteModal()" class="bg-white flex justify-center items-center border rounded-lg">
                                                <button
                                                    class="text-[#71747B] font-inter text-sm font-semibold flex justify-center items-center px-14 py-3 gap-x-2">
                                                    Cancel
                                                </button>
                                            </div>
                                            <div onclick="openDeleteModal()" class="bg-[#FF644F] flex justify-center items-center border rounded-lg">
                                                <button
                                                    class="text-white font-inter text-sm font-semibold flex justify-center items-center px-14 py-3 gap-x-2">
                                                    Delete
                                                </button>
                                            </div>
                                        </div>
